...
Report 50106 "ForNAV VAT Credit Memo_NAS"
{
	Caption = 'Credit Memo';
	UsageCategory = ReportsAndAnalysis;
	WordLayout = './Layouts/ForNAV VAT Credit Memo_NAS - Copy.docx'; DefaultLayout = Word;

	dataset
	{
		dataitem(Header;"Sales Cr.Memo Header")
		{
			CalcFields = "Amount Including VAT", Amount,"Amount Including VAT",Amount;
